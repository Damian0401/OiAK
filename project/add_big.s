...
.data                                     
    ...
    second: .long 0x00000001, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff
    second_len = (. - second) / 4
...
_add_ret:
    ...
    # if any digits of numbers still left - jmp to _add
    cmp $0, %edi
    jge _add 
    ...
    # clear eax and add carry as last step
    xor %eax, %eax
    popf
    adc $0, %eax
    mov %eax, (%ebx,%ecx,4)
